    ...
    container.innerHTML = uniqueWorkflows.map(workflow => `
        <div class="workflow-item">
            ...
            <div class="workflow-actions">
                ...
                <button onclick="executeWorkflow('${workflow.workflow_id}')" class="btn-execute">🚀 Execute</button>
    ...
    content.innerHTML = `
        <div class="conversation-container" id="conversation-${agentType}">
            <div class="agent-intro">
                <p>👋 Hello! I'm your ${agentNames[agentType]}. Ask me anything about your business challenges!</p>
                <p><small>💡 You can ask follow-up questions in this conversation.</small></p>
            </div>
        </div>
                ...
                <div class="section market-insights">
                    ...
                    <div class="market-grid">
                        <div class="market-card">
                            <h4>City: ${cityAnalysis.city || 'N/A'}</h4>
...
async function executeWorkflow(workflowId) {
    try {
        ...
        const response = await fetch(`/api/workflows/execute/${workflowId}`, {
            method: 'POST'
        });
        const data = await response.json();
        ...
        if (response.ok) {
            ...
            console.error('Failed to execute workflow:', data);
